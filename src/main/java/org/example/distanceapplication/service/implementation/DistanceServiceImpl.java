...
public class DistanceServiceImpl implements DistanceService {
    ...
    public double getDistanceInKilometres(CityInfo first, CityInfo second) {
        ...
        double radianValue = Math.sin(Math.toRadians(first.getLatitude())) * Math.sin(Math.toRadians(second.getLatitude()))
        ...
        return BigDecimal.valueOf(distance).setScale(4, RoundingMode.CEILING).doubleValue();
    }
}
